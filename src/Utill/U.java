...
public class U {
	...
	public	static int minDay=30; // minimum number of Days
	public	static int maxDay=30;  // maximum number of Days
	public	static int daySteps=1; // day step
	...
	public static double Qalpha    =0.1;  
 ...
 public static String firstNote="";
	...
	public static String testFile="Data/testFile.txt";	
...
/*	public static String dataFile34="Data/UCIFinalPredictionWithPython/pred_bikesharing.txt";
	public static String dataFile35="Data/UCIFinalPredictionWithPython/pred_housing.txt";
	public static String dataFile36="Data/UCIFinalPredictionWithPython/pred_forestfires.txt";
	public static String dataFile37="Data/UCIFinalPredictionWithPython/pred_airfoil.txt";
	public static String dataFile38="Data/UCIFinalPredictionWithPython/pred_yacht.txt";
	public static String dataFile39="Data/UCIFinalPredictionWithPython/pred_autompg.txt";

	
	public static String[]  dataFileArr_UCI2={dataFile34,dataFile35, dataFile36,dataFile37,dataFile38,  dataFile39 };
	 */
